...
contract BSCBridge is Ownable {
    ...
    function transit(
        ...
        TaalERC20(ercToBep[_ercToken]).mint(msg.sender, _amount);
    ...
    function payback(address _bepToken, uint256 _amount) external payable {
        ...
        TaalERC20(_bepToken).burn(msg.sender, _amount);
        ...
        onlyOwner
    {
        ...
        TaalERC20(_bepToken).transferOwnership(_to);
